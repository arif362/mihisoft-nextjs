  ...
  return (
    <section id="our_clients" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          <div>
            <h3 className="text-4xl font-bold text-[#48C7EC] mb-2">10+</h3>
            <p className="text-gray-600">Happy Clients</p>
          </div>
          <div>
            <h3 className="text-4xl font-bold text-[#48C7EC] mb-2">15+</h3>
          ...
          <div>
            <h3 className="text-4xl font-bold text-[#48C7EC] mb-2">100%</h3>
