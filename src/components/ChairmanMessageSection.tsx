  ...
  return (
    <section className="testimonials-section sec-padd py-20 bg-gradient-to-br from-[#48C7EC] via-[#3ab5db] to-[#2aa3c9] relative overflow-hidden" id="testimonials">
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="author flex flex-col md:flex-row items-center md:items-start gap-8 mb-8">
              ...
              <div className="text-center md:text-left flex-1" style={{ paddingLeft: '25px' }}>
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <p className="text-[#48C7EC] font-semibold text-lg mb-2">Chairman</p>
                ...
                >
                  <span className="px-3 py-1 bg-white/90 text-[#48C7EC] rounded-full text-sm font-medium shadow-sm">
                    Visionary Leader
                  </span>
                  <span className="px-3 py-1 bg-white/90 text-orange-600 rounded-full text-sm font-medium shadow-sm">
                    Tech Innovator
                  </span>
                  <span className="px-3 py-1 bg-white/90 text-green-600 rounded-full text-sm font-medium shadow-sm">
                    Business Strategist
                  </span>
                </motion.div>
              </div>
            ...
            >
              <blockquote className="text-center">
                ...
                <motion.p 
                  ...
                  viewport={{ once: true }}
                >
                  &ldquo;Our commitment to excellence and innovation drives us to deliver exceptional solutions that transform businesses and create lasting value for our clients worldwide.&rdquo;
                </motion.p>
              </blockquote>
            </motion.div>
            ...
            >
              <div className="inline-block">
                ...
                <p className="text-[#48C7EC] text-sm font-semibold">Mihisoft Technologies Ltd.</p>
              </div>
            </motion.div>
          </motion.div>
        </motion.article>
        ...
        {/* Decorative Elements */}
        <div className="absolute top-20 left-10 w-20 h-20 bg-white/20 rounded-full opacity-30 animate-bounce"></div>
        <div className="absolute bottom-20 right-10 w-16 h-16 bg-white/20 rounded-full opacity-20 animate-pulse"></div>
        <div className="absolute top-1/2 right-20 w-12 h-12 bg-white/30 rounded-full opacity-25 animate-ping"></div>
      </div>
    </section>
  )
}
