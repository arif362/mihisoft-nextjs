      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Message From <span className="text-yellow-400">Chairman</span>
          </h2>
        ...
        >
          ...
          <div className="quote text-center mb-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="inline-flex items-center justify-center w-20 h-20 bg-yellow-400 rounded-full shadow-lg"
            >
              <FaQuoteLeft className="text-3xl text-blue-900" />
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="author flex flex-col md:flex-row items-center md:items-start gap-8 mb-8">
              ...
              >
                <div className="relative">
                  ...
                  {/* Social Overlay */}
                  <div className="overlay absolute inset-0 bg-blue-600 bg-opacity-95 opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-full flex items-center justify-center">
            ...
            >
              <div className="inline-block">
                ...
                <p className="text-gray-500 text-sm font-medium">Chairman & Founder</p>
