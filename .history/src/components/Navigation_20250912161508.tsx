        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="hidden lg:block">
            <button
              ...
              className="bg-[#48C7EC] text-white px-6 py-2 rounded-lg hover:bg-[#3ab5db] transition-colors font-medium"
            >
              GET A Quote
            </button>
          </div>
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="py-4 space-y-4">
                ...
                <button
                  onClick={() => scrollToSection('contact_us')}
                  className="w-full bg-[#48C7EC] text-white px-6 py-2 rounded-lg hover:bg-[#3ab5db] transition-colors font-medium"
                >
                  GET A Quote
                </button>
              </div>
