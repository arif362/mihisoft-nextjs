  ...
  const teamMembers = [
    {
      ...
      description: 'Passionate entrepreneur building innovative solutions to transform businesses through cutting-edge technology and agile development.',
      experience: '5+ Years',
      achievements: ['Startup Founder', 'Tech Visionary', 'Agile Leader'],
      social: {
    ...
    },
    {
      ...
      description: 'Technical co-founder passionate about building scalable solutions and leading development teams to deliver exceptional products.',
      experience: '4+ Years',
      achievements: ['Tech Co-Founder', 'Full-Stack Expert', 'Team Leader'],
      social: {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Leadership <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Excellence</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Experienced leaders driving innovation and success with visionary thinking and strategic expertise
          </p>
          <div className="mt-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-blue-200">
