...
export default function HeroSection() {
  ...
  const slides = useMemo(() => [
    {
      ...
      subtitle: 'Transforming your business with cutting-edge technology and agile development.',
    ...
    },
    {
      ...
      subtitle: 'Empowering businesses with modern solutions for rapid growth and efficiency.',
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
            ...
            >
              ...
              >
                {slides[currentSlide].title.split(' ').map((word, index) => {
                  if (word === 'Solutions' || word === 'Development' || word === 'Transformation') {
                    return <span key={index} className="text-blue-400 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">{word} </span>
                  }
                  return word + ' '
                })}
              </motion.h1>
              ...
              >
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-10 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-3 shadow-lg hover:shadow-xl"
                >
      ...
      {/* Slide Counter */}
      <div className="absolute bottom-8 left-8 text-white text-sm font-medium z-30">
