  ...
  const teamMembers = [
    {
      ...
      description: 'Visionary leader driving innovation and strategic growth with over 15 years of experience in technology leadership.',
      experience: '15+ Years',
      achievements: ['Tech Innovator', 'Strategic Leader', 'Industry Expert'],
      social: {
    ...
    },
    {
      ...
      description: 'Operations excellence leader ensuring seamless project delivery and organizational efficiency across all departments.',
      experience: '12+ Years',
