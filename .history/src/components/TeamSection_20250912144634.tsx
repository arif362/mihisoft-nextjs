      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Startup <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Founders</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Young entrepreneurs building the future with innovative technology solutions and startup agility
          </p>
          <div className="mt-8">
